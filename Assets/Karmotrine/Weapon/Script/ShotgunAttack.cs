...
public class ShotgunAttack : Skill
{
    ...
    public override void Use(Weapon weapon)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            ObjectManager.Instance.PopObject(resource.name,
                Wakgood.Instance.AttackPosition.position + ((Vector3)Random.insideUnitCircle.normalized * 0.4f),
                Wakgood.Instance.AttackPosition.rotation.eulerAngles);
