...
public class BuisinessKim : BossMonster
{
    ...
    private readonly BSlash[] skill0AttackGo = new BSlash[2];
    ...
    protected override void Awake()
    {
        ...
        (skill0AttackGo[0] = Instantiate(skill0AttackPrefab, transform).GetComponent<BSlash>()).gameObject
            .SetActive(false);
        (skill0AttackGo[1] = Instantiate(skill0AttackPrefab, transform).GetComponent<BSlash>()).gameObject
            .SetActive(false);
    ...
    protected IEnumerator Skill0()
    {
        ...
        float angle = Mathf.Atan2(Wakgood.Instance.transform.position.y - (transform.position.y + 1),
            Wakgood.Instance.transform.position.x - transform.position.x) * Mathf.Rad2Deg;
    ...
    protected IEnumerator ULT()
    {
        ...
        for (int i = 0; i < ultCount; i++)
        {
            ...
            GameObject temp = ObjectManager.Instance.PopObject("BuisSlash", originPos + ((originPos2 - originPos) / 2),
