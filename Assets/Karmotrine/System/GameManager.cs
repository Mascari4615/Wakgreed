...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        CinemachineVirtualCamera =
            Camera.main.transform.parent.Find("CM Camera").GetComponent<CinemachineVirtualCamera>();
        CinemachineTargetGroup =
            Camera.main.transform.parent.Find("CM TargetGroup").GetComponent<CinemachineTargetGroup>();
    ...
    private void Update()
    {
        isFocusOnSomething.RuntimeValue = StreamingManager.Instance.IsChatting || isLoading.RuntimeValue ||
                                          isShowingSomething.RuntimeValue;
    ...
    private IEnumerator CheckBuff()
    {
        while (true)
        {
            ...
            {
                if (buff.hasCondition)
                {
                    continue;
                }

                if (buff.removeTime <= Time.time)
                {
